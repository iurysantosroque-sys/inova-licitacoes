const CACHE='inova-licitacoes-v40.2.1';
const CORE=[
  './','./index.html','./styles.css?v=40.2.1','./app.js?v=40.2.1','./manifest.json?v=40.2.1',
  './assets/logo.png','./assets/papel-timbrado.png','./assets/papel-timbrado-paisagem.pdf','./assets/papel-timbrado-paisagem.png','./assets/controle-documentos.png','./icons/icon-192-v2.png?v=40.2.1','./icons/icon-512-v2.png?v=40.2.1'
];
