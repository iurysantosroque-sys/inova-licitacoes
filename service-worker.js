const CACHE='inova-licitacoes-v36.14.5';
const CORE=[
  './','./index.html','./styles.css?v=36.14.5','./app.js?v=36.14.5','./manifest.json?v=36.14.5',
  './assets/logo.png','./icons/icon-192-v2.png?v=36.14.5','./icons/icon-512-v2.png?v=36.14.5'
];
