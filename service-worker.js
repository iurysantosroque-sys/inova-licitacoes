const CACHE='inova-licitacoes-v36.23.2';
const CORE=[
  './','./index.html','./styles.css?v=36.23.2','./app.js?v=36.23.2','./manifest.json?v=36.23.2',
  './assets/logo.png','./assets/papel-timbrado.png','./icons/icon-192-v2.png?v=36.23.2','./icons/icon-512-v2.png?v=36.23.2'
];
