const CACHE='inova-licitacoes-v38.8.0';
const CORE=[
  './','./index.html','./styles.css?v=38.8.0','./app.js?v=38.8.0','./manifest.json?v=38.8.0',
  './assets/logo.png','./assets/papel-timbrado.png','./assets/papel-timbrado-paisagem.pdf','./assets/papel-timbrado-paisagem.png','./assets/controle-documentos.png','./icons/icon-192-v2.png?v=38.8.0','./icons/icon-512-v2.png?v=38.8.0'
];
