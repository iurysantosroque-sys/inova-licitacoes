const CACHE='inova-licitacoes-v36.17.9';
const CORE=[
  './','./index.html','./styles.css?v=36.17.9','./app.js?v=36.17.9','./manifest.json?v=36.17.9',
  './assets/logo.png','./icons/icon-192-v2.png?v=36.17.9','./icons/icon-512-v2.png?v=36.17.9'
];
