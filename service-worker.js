const CACHE='inova-licitacoes-v36.21.11';
const CORE=[
  './','./index.html','./styles.css?v=36.21.11','./app.js?v=36.21.11','./manifest.json?v=36.21.11',
  './assets/logo.png','./icons/icon-192-v2.png?v=36.21.11','./icons/icon-512-v2.png?v=36.21.11'
];
