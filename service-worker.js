const CACHE='inova-licitacoes-v36.20.1';
const CORE=[
  './','./index.html','./styles.css?v=36.20.1','./app.js?v=36.20.1','./manifest.json?v=36.20.1',
  './assets/logo.png','./icons/icon-192-v2.png?v=36.20.1','./icons/icon-512-v2.png?v=36.20.1'
];
