const CACHE='inova-licitacoes-v45.0.52';
const CORE=[
  './','./index.html','./styles.css?v=45.0.52','./app.js?v=45.0.52','./manifest.json?v=45.0.52',
  './assets/logo.png','./assets/papel-timbrado.png','./assets/papel-timbrado-paisagem.pdf','./assets/papel-timbrado-paisagem.png','./icons/icon-192-v2.png?v=45.0.52','./icons/icon-512-v2.png?v=45.0.52'
];
