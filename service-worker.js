const CACHE='inova-licitacoes-v36.16.4';
const CORE=[
  './','./index.html','./styles.css?v=36.16.4','./app.js?v=36.16.4','./manifest.json?v=36.16.4',
  './assets/logo.png','./icons/icon-192-v2.png?v=36.16.4','./icons/icon-512-v2.png?v=36.16.4'
];
