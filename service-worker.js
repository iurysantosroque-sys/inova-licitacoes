const CACHE='inova-licitacoes-v36.21.10';
const CORE=[
  './','./index.html','./styles.css?v=36.21.10','./app.js?v=36.21.10','./manifest.json?v=36.21.10',
  './assets/logo.png','./icons/icon-192-v2.png?v=36.21.10','./icons/icon-512-v2.png?v=36.21.10'
];
